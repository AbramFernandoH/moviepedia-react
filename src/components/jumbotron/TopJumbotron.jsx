...
function TopJumbotron() {
  return (
    <header className="top-jumbotron p-5 mb-4 text-white vh-100" style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.8)), url(${process.env.REACT_APP_IMAGE_PREFIX_URL}/iQFcwSGbZXMkeyKrxbPnwnRo5fl.jpg)` }}>
